  ...
  return (
    <Section id="how-to-use">
      <div className="container ">
        ...
        flex items-center h-[39rem] mb-5 p-8 border 
        ...
        lg:p-20 xl:h-[46rem]"
          >
            ...
            bottom-4 border border-n-1/10 lg:left-1/2 lg:right-auto
          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            ...
            >
              ...
              <div
                ...
                bg-gradient-to-b from-n-8/90 to-n-8/90 lg:p-15"
              >
            ...
            >
              ...
              <div
                ...
                bg-n-8 rounded-xl overflow-hidden md:h-[25rem]"
              >
                <img
                  src={service3}
